...
func PutStatus(w http.ResponseWriter, r *http.Request) {
	...
	var uStatus models.UpdateStatus
	err := json.NewDecoder(r.Body).Decode(&uStatus)
	if err != nil {
	...
	var message models.MessageNewTS = models.MessageNewTS{
		...
		NewTS: "На задачу установлен статус " + uStatus.NewStatus,
	}
